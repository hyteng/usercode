...
void TrackAnalysisbyAssociator(string FileName) {
    ...
    TH1F* deltaPtatimpactTSOSmaxPurity = new TH1F("deltaPtatimpactTSOSmaxPurity", "deltaPtatimpactTSOSmaxPurity", 150, -1.*3., 3.);
    ...
    for(int i = 0; i < Nentries; i++) {
        ...
        if(trackingParticleMatch == 0) {
            ...
            deltaPtatimpactTSOSmaxPurity->Fill((recTrackimpactMomentumofTSOS_temp-simTrackMomentumPt_temp)/simTrackMomentumPt_temp);
    ...
    SaveName=FileName+"_EfficiencyforTrackingParticle.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(1);
    maxPurityperTrackingParticle->Draw("");
    SaveName=FileName+"_maxPurityperTrackingParticle.eps";OutputCanvas->SaveAs(SaveName.c_str());
    MultiplicityperTrackingPartile->Draw("");
    SaveName=FileName+"_MultiplicityperTrackingPartile.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(0);
    recTrackrefMomentummaxPurity->Draw("");
    SaveName=FileName+"_recTrackrefMomentummaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackrefPhimaxPurity->Draw("");
    SaveName=FileName+"_recTrackrefPhimaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackrefEtamaxPurity->Draw("");
    SaveName=FileName+"_recTrackrefEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackinnerMomentummaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerMomentummaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackinnerPhimaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerPhimaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackinnerEtamaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(1);
    recTrackinnerValidmaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerValidmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(0);
    recTrackouterMomentummaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterMomentummaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackouterPhimaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterPhimaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackouterEtamaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(1);
    recTrackouterValidmaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterValidmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(0);
    simTrackMomentumPtmaxPurity->Draw("");
    SaveName=FileName+"_simTrackMomentumPtmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackPhimaxPurity->Draw("");
    SaveName=FileName+"_simTrackPhimaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackEtamaxPurity->Draw("");
    SaveName=FileName+"_simTrackEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackinnerMomentummaxPurity->Draw("");
    SaveName=FileName+"_simTrackinnerMomentummaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackinnerPhimaxPurity->Draw("");
    SaveName=FileName+"_simTrackinnerPhimaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackinnerEtamaxPurity->Draw("");
    SaveName=FileName+"_simTrackinnerEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackinnerMatchmaxPurity->Draw("");
    SaveName=FileName+"_simTrackinnerMatchmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackouterMomentummaxPurity->Draw("");
    SaveName=FileName+"_simTrackouterMomentummaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackouterPhimaxPurity->Draw("");
    SaveName=FileName+"_simTrackouterPhimaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackouterEtamaxPurity->Draw("");
    SaveName=FileName+"_simTrackouterEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    simTrackouterMatchmaxPurity->Draw("");
    SaveName=FileName+"_simTrackouterMatchmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackinnerMomentumofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerMomentumofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackinnerPhiofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerPhiofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackinnerEtaofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerEtaofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(1);
    recTrackinnerValidofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackinnerValidofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(0);
    recTrackouterMomentumofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterMomentumofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackouterPhiofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterPhiofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackouterEtaofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterEtaofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(1);
    recTrackouterValidofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackouterValidofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    myPad->SetLogy(0);
    recTrackimpactMomentumofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackimpactMomentumofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackimpactPhiofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackimpactPhiofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    ...
    SaveName=FileName+"_recTrackimpactEtaofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    recTrackimpactValidofTSOSmaxPurity->Draw("");
    SaveName=FileName+"_recTrackimpactValidofTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    deltaPtatimpactTSOSmaxPurity->SetStats(1);
    deltaPtatimpactTSOSmaxPurity->GetXaxis()->SetTitle("(recPt-simPt)/simPt");
    deltaPtatimpactTSOSmaxPurity->GetXaxis()->CenterTitle(1);
    gStyle->SetOptFit(0111);
    deltaPtatimpactTSOSmaxPurity->Fit("gaus","", "", -1., 1.);
    deltaPtatimpactTSOSmaxPurity->Draw("");
    SaveName=FileName+"_deltaPtatimpactTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    Particle2simPtHist->Draw("");
    SaveName=FileName+"_Particle2simPt.eps";OutputCanvas->SaveAs(SaveName.c_str());
    STA2simPtHist->Draw("");
    SaveName=FileName+"_STA2simPt.eps";OutputCanvas->SaveAs(SaveName.c_str());
    ...
    Eff2simPtHist->Draw("");
    SaveName=FileName+"_Eff2simPt.eps";OutputCanvas->SaveAs(SaveName.c_str());
    ...
    SaveName=FileName+"_EfficiencyEtamaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
    ...
    SaveName=FileName+"_ChargeCheckHistTSOSmaxPurity.eps";OutputCanvas->SaveAs(SaveName.c_str());
}
