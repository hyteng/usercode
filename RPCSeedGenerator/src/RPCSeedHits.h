...
class RPCSeedHits {
  ...
  TrajectorySeed seed(const edm::EventSetup& eSetup, double MaxRSD, int &isGoodSeed) const;
  ...
  void computeBestPt(double* pt, double* spt, float& ptmean, float& sptmean, int NumberofPt) const;
