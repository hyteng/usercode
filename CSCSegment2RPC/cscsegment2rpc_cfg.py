...
process.rpceff = cms.EDAnalyzer('CSCSegment2RPC',
        ...
        EffSaveRootFile2 = cms.untracked.bool(True),
        EffRootFileName = cms.untracked.string('RPCEfficiencyHist.root'),
        EffRootFileName2 = cms.untracked.string('RPCEfficiencyTree.root'),
        ...
        coneAngleX = cms.double(0.1),
        coneAngleY = cms.dounle(-0.1),
        minSegmentEta = cms.double(-3.0),
